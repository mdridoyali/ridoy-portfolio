...
const Navbar = () => {
  ...
  return (
    <div className="">
      <div className="navbar fixed max-w-[1349px] md:pt-5   md:-mt-[20px] bg-black opacity-50">
        <div className="navbar-start pl-10">
          ...
          <a className=" text-3xl font-bold text-white ">Ri<span className="text-amber-500" >doy</span></a>
        </div>
